...
topics:
  ...
  - name: "knowledge"
    ...
    content:
      ...
      - level: 5
        criteria:
          - "Constantly innovating, learning, teaching and looking for new ways to do things which haven't been done before. Shares these new ways of doing things internally and externally. Is a recognised industry expert outside of Xfers."
    ...
    content:
      - level: 1
        criteria:
          ...
          - "Builds relationships within Xfers and contributes to building a supportive, knowledgeable and engaged peer group"
    ...
    content:
      - level: 1
        criteria:
          ...
          - "Brings new ideas to the table to improve technical aspects of Xfersnaut’s day to day life"
      - level: 2
        criteria:
      ...
      - level: 5
        criteria:
          ...
          - "Given as a reason for other engineers to join Xfers"
    ...
    content:
      ...
      - level: 4
        criteria:
          ...
          - "Instills Xfers engineering principles into the team, even for operational tasks"
