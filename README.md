<p align="center">
  <a href="https://www.Xfers.com">
    <img alt="Xfers favicon" src="https://user-images.githubusercontent.com/906931/82824899-c3037980-9edc-11ea-975f-80b068f19ca1.png" width="60" />
  </a>
</p>
<h1 align="center">
...
🎉 Welcome to the Progression at Xfers repository

This is where all of Xfers's progression frameworks live, as well as the site that powers `progression.Xfers.com` 💪
...
- Xfersnauts can "own" or manage a framework (or frameworks), meaning they get to control any changes or additions in that area
    ...
    content:
      - level: 1
        criteria:
          ...
          - "Builds relationships within Xfers and contributes to building a supportive, knowledgable and engaged peer group"
        exampleCriteria:
...
If you need any help and are a Xfersnaut, ping @lucas a message or put a message in #org-scaling. Otherwise, feel free to raise an issue here in GitHub.
...
*If you've seen the word 'repo', we're probably talking about the Progression Framework folder in GitHub that you're on right now (https://github.com/Xfers/progression-framework)*
...
Take a look at the readme in the `src/` directory (https://github.com/Xfers/progression-framework/blob/master/src/README.md)
