      ...
      <Layout data={this.props.data}>
        <DescriptionView>
          <DescriptionTitleGroup>
            ...
            <Title>Progression at Xfers 🎉</Title>
          </DescriptionTitleGroup>
          <Description>
            <DescriptionText>
              This is where we keep the progression frameworks we use at Xfers.
            </DescriptionText>
            <DescriptionText>
            ...
            <DescriptionText>
              We&apos;ve put them here for everyone at Xfers (and anyone in the
              world!) to use.
            </DescriptionText>
            <DescriptionText>
            ...
            <DescriptionText>
              ...
              <a href="https://github.com/xfers/progression-framework">
                <FontAwesomeIcon icon={faGithub} />{' '}
                @xfers/progression-framework.
              </a>
            </DescriptionText>
            <DescriptionText>
              You can find out more about progression at Xfers and what it means
              for us in this{' '}
